...
/////////////////////////////////////////////////////////////////////////////////
public class Particle extends JOGLBase {
   ...
   public void render(GLAutoDrawable a) {
      ...
      GraphicUtil.setPerspectiveView(gl2, viewWidth/viewHeight, 30.0f, 1, 1000);
      ...
      gl2.glBindTexture(GL2.GL_TEXTURE_2D, texId[0]);
